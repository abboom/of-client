...
import { TABS_ITEM_FN, TABS_ITEM_SELECT, TABS_KEY } from '@/components/tabs/index.ts'
...
<template>
  <div ref="wrap" w-full h-fit>
    <div relative>
      <div ref="paneWrap" w-fit h-fit flex relative>
        <component :is="c" v-for="c in comp" :key="c.key" />
      </div>

      <div class="h-[3px] w-full" :class="sliderTrackCls">
        <div
          v-if="offsetX > 0"
